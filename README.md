...
For each of the 112 networks on six nodes, we constructed 100 random weight assignments. [6_nodes_Bd.ipynb](6_nodes_Bd.ipynb) contains the code for generation and classification of these weighted networks for the Bd updating rule, and [6_nodes_dB.ipynb](6_nodes_dB.ipynb) contains the code for generation and classification of these weighted networks for the Bd updating rule
